...
// LOAD MODEL HERE !
const model_sign_language = tf.loadLayersModel('https://storage.googleapis.com/sign-language-translator-v7/model.json');
...
function onResults(results) {
  ...
  if (list_poses.length > 29) {
    ...
    async function processModel(){
      const model = await tf.loadLayersModel('https://storage.googleapis.com/sign-language-translator-v7/model.json');
